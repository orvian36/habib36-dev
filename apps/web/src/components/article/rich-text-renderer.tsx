...
type BlockNodeFields = { node: { fields: Record<string, unknown> } };
...
export function RichTextRenderer({
  ...
  const converters: JSXConvertersFunction = ({ defaultConverters }) => ({
    ...
    blocks: {
      ...
      imagePair: ({ node }: BlockNodeFields) => {
